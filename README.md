...
| **Chế Độ Giao Diện & Dark Mode** | Chỉ có 1 theme sáng duy nhất, gây mỏi mắt khi làm việc ban đêm, nháy trắng khi F5.     | **Multi-Theme Engine (5 Themes + Auto)**: Warm Terracotta, Obsidian Dark (`#141210`), Nordic Slate, Forest Sage, Solarized Paper. Chống nháy sáng Anti-FOUC, tự đổi theme sơ đồ Mermaid theo thời gian thực. |
